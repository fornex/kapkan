...
activeAttacks: { one: "# aktiver Angriff", other: "# aktive Angriffe" },
    ...
    strings: {
      ...
      "ed.nozones.sub": "Eine Zone erscheint, sobald ein Knoten sie im Modus decide bedient und sein erstes Zehn-Sekunden-Fenster geschlossen hat.",
      "ed.zones": "Zonen",
      "ed.zone": "Zone",
      "ed.nodes": "Knoten",
      "ed.rps": "Anfr./s",
      ...
      "ed.wouldbe.shed": "Die Knoten haben ihre Quellendetails gekürzt, damit der Bericht ins Limit passt; die Zähler oben sind vollständig, die Namen nicht.",
      "ed.challenge.active": "aktiv auf {n}",
