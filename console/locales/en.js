...
activeAttacks: { one: "# active attack", other: "# active attacks" },
    ...
    strings: {
      ...
      "ed.nozones.sub": "A zone appears once a node serves it in decide mode and has closed its first ten-second window.",
      "ed.zones": "Zones",
      "ed.zone": "Zone",
      "ed.nodes": "Nodes",
      "ed.rps": "req/s",
      ...
      "ed.wouldbe.shed": "The nodes shed their per-source detail to fit their reports; the counters above are whole, the names are not.",
      "ed.challenge.active": "active on {n}",
