...
(function (w) {
  ...
  w.KAPKAN_LOCALES.en = {
    ...
    strings: {
      ...
      "ed.nozones.sub": "Nodes up: {n}. A zone appears once a node has closed its first ten-second window.",
      "ed.zones": "Zones",
      "ed.note": "Each node's last ten-second window, summed across {n} reporting node(s).",
      "ed.zone": "Zone",
      "ed.nodes": "Nodes",
      "ed.rps": "req/s",
      ...
      "ed.watchonly": "watch-only on {n} node(s)",
