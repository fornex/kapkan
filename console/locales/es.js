...
activeAttacks: { one: "# ataque activo", other: "# ataques activos" },
    ...
    strings: {
      ...
      "ed.nozones.sub": "Una zona aparece cuando un nodo la sirve en modo decide y ha cerrado su primera ventana de diez segundos.",
      "ed.zones": "Zonas",
      "ed.zone": "Zona",
      "ed.nodes": "Nodos",
      "ed.rps": "sol./s",
      ...
      "ed.wouldbe.shed": "Los nodos recortaron el detalle por origen para que el informe cupiera en el límite; los contadores de arriba están completos, los nombres no.",
      "ed.challenge.active": "activa en {n}",
      "ed.requests": "Solicitudes",
      "ed.source": "Origen",
      "ed.wouldbe.title": "Quién sería comprobado",
      "ed.wouldbe.sub": "Orígenes para los que los nodos, en modo de prueba, habrían previsto una comprobación o un rechazo — a quién afectaría activar el escalón. Los más activos primero.",
