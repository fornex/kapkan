...
(function (w) {
  ...
  w.KAPKAN_LOCALES.es = {
    ...
    strings: {
      ...
      "ed.nozones.sub": "Nodos activos: {n}. Una zona aparece cuando un nodo cierra su primera ventana de diez segundos.",
      "ed.zones": "Zonas",
      "ed.note": "Última ventana de diez segundos de cada nodo, sumada en {n} nodo(s) que informan.",
      "ed.zone": "Zona",
      "ed.nodes": "Nodos",
      "ed.rps": "sol./s",
      ...
      "ed.watchonly": "solo observación en {n} nodo(s)",
