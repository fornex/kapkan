...
activeAttacks: { one: "# attaque active", other: "# attaques actives" },
    ...
    strings: {
      ...
      "ed.nozones.sub": "Une zone apparaît dès qu'un nœud la sert en mode decide et a clos sa première fenêtre de dix secondes.",
      "ed.zones": "Zones",
      "ed.zone": "Zone",
      "ed.nodes": "Nœuds",
      "ed.rps": "req/s",
      ...
      "ed.wouldbe.shed": "Les nœuds ont élagué le détail par source pour tenir dans leur rapport ; les compteurs ci-dessus sont entiers, les noms ne le sont pas.",
      "ed.challenge.active": "active sur {n}",
