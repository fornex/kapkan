...
(function (w) {
  ...
  w.KAPKAN_LOCALES.fr = {
    ...
    strings: {
      ...
      "ed.nozones.sub": "Nœuds actifs : {n}. Une zone apparaît dès qu'un nœud a clos sa première fenêtre de dix secondes.",
      "ed.zones": "Zones",
      "ed.note": "Dernière fenêtre de dix secondes de chaque nœud, sommée sur {n} nœud(s) remontant.",
      "ed.zone": "Zone",
      "ed.nodes": "Nœuds",
      "ed.rps": "req/s",
      ...
      "ed.watchonly": "observation seule sur {n} nœud(s)",
