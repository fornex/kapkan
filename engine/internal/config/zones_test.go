...
func TestParseZonesRejects(t *testing.T) {
	...
	cases := []struct {
		...
		{"h3 options without h3", "zones:\n  - name: a.example\n" + ok + "\n    tls: {h3_options: {advertise: false}}\n", "tls.h3_options needs tls.h3"},
		{"h3 alt-svc max-age too small", "zones:\n  - name: a.example\n" + ok + "\n    tls: {h3: true, h3_options: {alt_svc_max_age_seconds: 59}}\n", "alt_svc_max_age_seconds must be 60..604800"},
		{"h3 alt-svc max-age too large", "zones:\n  - name: a.example\n" + ok + "\n    tls: {h3: true, h3_options: {alt_svc_max_age_seconds: 604801}}\n", "alt_svc_max_age_seconds must be 60..604800"},
