...
on](/docs/edge#placing-zones-on-nodes) — so whichever of them the validation lands on answers
...
zone's windows, undecided `2xx`, which is why an idle zone's [history](/docs/storage#edge-history)
